...
Reviews.delete_all
Reviews.create("title" => "Orphan Train", "rating" => "5", "feedback" => "Riveting!")
Reviews.create("title" => "Orphan Train", "rating" => "2", "feedback" => "About as dull as you can get.")
Reviews.create("title" => "Orphan Train", "rating" => "3", "feedback" => "Not bad.")
Reviews.create("title" => "Shadow Spell", "rating" => "4", "feedback" => "Great book, and not too many pages.")
Reviews.create("title" => "Shadow Spell", "rating" => "4", "feedback" => "Excellent font and margins. Story wasn't bad either.")
Reviews.create("title" => "Shadow Spell", "rating" => "4", "feedback" => "Worth reading when there isn't a hockey game on.")
Reviews.create("title" => "Shadow Spell", "rating" => "1", "feedback" => "Didn't understand it at all.")
Reviews.create("title" => "The Alchemist", "rating" => "2", "feedback" => "I thought this was about how to make gold?")
Reviews.create("title" => "The Alchemist", "rating" => "4", "feedback" => "Suspensful plot, good characters.")
Reviews.create("title" => "The Alchemist", "rating" => "5", "feedback" => "Perfect. A work of art.")
Reviews.create("title" => "The Alchemist", "rating" => "3", "feedback" => "Kind of confusing.")
